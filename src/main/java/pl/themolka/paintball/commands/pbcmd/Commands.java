...
public class Commands {
	...
	public static boolean list(CommandSender sender, int page) {
		int nextPage = page + 1;
		if(page == 1) {
			sender.sendMessage(ChatColor.GOLD + " ===== xPaintball's commands <Page " + page + "/2> ===== ");
			...
			sender.sendMessage(ChatColor.GOLD + "/pb help " + ChatColor.GRAY + "- xPaintball's Help Center");
			sender.sendMessage(ChatColor.GOLD + "/pb info " + ChatColor.GRAY + "- Show xPaintball's Help Center");
